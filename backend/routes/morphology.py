...
async def apply_erosion(
    ...
    return process_morph_image(file_bytes, 'erosion', kernel_size=kernel_size, shape=shape, iterations=iterations)
...
async def apply_dilation(
    ...
    file_bytes = await file.read()
    return process_morph_image(file_bytes, 'dilation', kernel_size=kernel_size, shape=shape, iterations=iterations)
